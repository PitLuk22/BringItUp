...
/* harmony import */ var _modules_sliders_slider_main__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/sliders/slider-main */ "./src/js/modules/sliders/slider-main.js");
/* harmony import */ var _modules_sliders_slider_mini__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/sliders/slider-mini */ "./src/js/modules/sliders/slider-mini.js");
...
/* harmony import */ var _modules_multiPage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/multiPage */ "./src/js/modules/multiPage.js");
...
window.addEventListener('DOMContentLoaded', function () {
  new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_4__["default"]('.showup .play', '.overlay').init();
  new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_4__["default"]('.moduleapp .play', '.overlay').init();
  var slider = new _modules_sliders_slider_main__WEBPACK_IMPORTED_MODULE_2__["default"]({
    container: '.page',
    btns: '.next'
  });
  slider.render();
  var modulePageSlider = new _modules_sliders_slider_main__WEBPACK_IMPORTED_MODULE_2__["default"]({
    container: '.moduleapp',
    btns: '.next'
  });
  modulePageSlider.render();
  var moduleApp = new _modules_sliders_slider_main__WEBPACK_IMPORTED_MODULE_2__["default"]({
    container: '.moduleapp',
    prev: '.module__info-controls .prev',
    next: '.module__info-controls .next'
  });
  moduleApp.render();
  var showUpSlider = new _modules_sliders_slider_mini__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  showUpSlider.init();
  var modulesSlider = new _modules_sliders_slider_mini__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  modulesSlider.init();
  var feedSlider = new _modules_sliders_slider_mini__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  new _modules_form__WEBPACK_IMPORTED_MODULE_1__["default"]('form', 'assets/question.php').init();
  ...
  new _modules_multiPage__WEBPACK_IMPORTED_MODULE_7__["default"]('http://localhost:4000/', 'http://localhost:4000/modules.html').init();
});
...
function () {
  ...
  _createClass(Difference, [{
    ...
    value: function hideItems(items) {
      items.forEach(function (card, index, arr) {
    ...
    value: function init() {
      try {
        ...
        this.hideItems(this.newItems); // Here we pass the plus, counter and array of elements inside the group
    ...
    key: "bindTriggers",
    value: function bindTriggers(plus, count, items) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Downlad; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
...
/*#__PURE__*/
function () {
  function Downlad(triggers) {
    _classCallCheck(this, Downlad);

    this.btns = document.querySelectorAll(triggers);
    this.path = 'assets/img/Bitmap.jpg';
  }

  _createClass(Downlad, [{
    key: "init",
    value: function init() {
      var _this = this;
  ...
  _createClass(Form, [{
    ...
    value: function submit(form) {
      ...
      form.addEventListener('submit', function (event) {
        ...
        var modal = _this2.overlay.children[0]; // Create IMG block and start spinner

        var statusImg = document.createElement('img');
        statusImg.classList.add('overlay__form-img');
        statusImg.setAttribute('src', _this2.message.spinner);
        modal.appendChild(statusImg); // Create TEXT block

        var statusText = document.createElement('div');
        statusText.classList.add('overlay__form-text');
        modal.appendChild(statusText); // Show overlay
        ...
        _this2.postData(_this2.path, formData).then(function (res) {
          console.log(res);
          statusImg.setAttribute('src', _this2.message.successImg);
          statusText.textContent = _this2.message.successText;
        }).catch(function () {
          statusImg.setAttribute('src', _this2.message.failImg);
          statusText.textContent = _this2.message.failText;
        }).finally(function () {
          form.reset();
    ...
    value: function initMask() {
      ...
      inputs.forEach(function (input) {
        ...
        input.addEventListener('blur', createMask); // don't allow moving cursor to the left
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MultiPage; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
...
/*#__PURE__*/
function () {
  function MultiPage(mainUrl, secondUrl) {
  ...
  _createClass(MultiPage, [{
    key: "init",
    value: function init() {
      var _this = this;

      document.querySelectorAll('.menu__block-schedule').forEach(function (elem) {
        elem.addEventListener('click', function () {
          var currentUrl = window.location.href;

          if (currentUrl === _this.main) {
            window.location.href = _this.second;
          } else {
            window.location.href = _this.main;
          }
        });
      });
    }
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlide(n) {
      ...
      this.slides[this.slideIndex - 1].classList.add('slideInUp'); // set timeout on the third slide for popup card
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn) {
        ...
        btn.parentElement.previousElementSibling.addEventListener('click', function (event) {
          event.preventDefault();
          _this2.slideIndex = 1;
...
function (_Slider) {
  ...
  function MiniSlider(container, prev, next, activeClass, animateActiveElem, autoplay) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, prev, next, activeClass, animateActiveElem, autoplay));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.next[0].addEventListener('click', function (e) {
        for (var i = 1; i < _this2.slides.length; i++) {
      ...
      this.prev[0].addEventListener('click', function (e) {
    ...
    value: function initAutoPlay() {
      ...
      [this.container, this.next[0], this.prev[0]].forEach(function (elem) {
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      animateActiveElem = _ref.animateActiveElem,
...
function () {
  ...
  _createClass(VideoPlayer, [{
    ...
    key: "bindCloseBtn",
    value: function bindCloseBtn(elem) {
      var _this2 = this;
    ...
    value: function onPlayerStateChange(state) {
      try {
        ...
        var svgPlay = this.activeBtn.querySelector('svg').cloneNode(true); // '0' means that video has been ended
